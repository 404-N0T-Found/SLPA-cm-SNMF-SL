...
class SNMFSl:
    def __init__(self, input_file,outDieDai,passt):
        ...
        self.name="outPut_"+str(passt)+".txt"
        ...
        self.aimM = smallWorldMatrix.createN(self.aimM, 2, self.N, passt,self.D,self.LAMDA/self.N)
...
def main():
    ...
    for i in range(23):
        outDieDai = []
        SNMFSl("network3.dat",outDieDai,floata)
        floata -= 0.05

        #f_out = open(stri+str(floata)+".txt", "w+")
