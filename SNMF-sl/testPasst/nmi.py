...
def main(input_file,gold_standard_file):
...
if __name__ == "__main__":
    input_file = "outPut_"
    gold_standard_file = "community3.dat"

    tempList=[]
    floata=1.00
    for i in range(20):
        tempList.append(main(input_file+str(floata)+".txt",gold_standard_file))
        floata-=0.05

    outPut(tempList)

    #print(main(input_file,gold_standard_file))
